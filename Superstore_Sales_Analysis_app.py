...
with cl1:
    with st.expander("View Data of Category wise Sales"):
...
with cl2:
    with st.expander("View Data of Region wise Sales"):
...
data1['layout'].update(title="Relationship between Sales and Profits using Scatter Plot",
                       titlefont = dict(size=26),xaxis = dict(title="Sales",titlefont=dict(size=19)),
...
st.download_button('Download Original Dataset', data = csv, file_name = "Data.csv",mime = "text/csv", help = 'Click here to download the data as a CSV file')      
